...
export const NoteDeleteModal: React.FC<NoteDeleteModalProps> = ({ isOpen, onClose, onConfirm }) => {
      ...
      >
        <div className="p-8 text-center">
          ...
          <p className="text-on-surface-variant text-sm leading-relaxed mb-8">
            Estás a punto de eliminar permanentemente esta observación. 
            <br />
            Esta acción no se puede deshacer y se borrará del historial.
          </p>
